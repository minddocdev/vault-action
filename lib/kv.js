...
function importKV2Secrets(client, secrets, token) {
    return __awaiter(this, void 0, void 0, function* () {
        secrets.forEach(({ path, key, env }) => __awaiter(this, void 0, void 0, function* () {
            const res = yield client.post(`/data/${path}`, { token });
